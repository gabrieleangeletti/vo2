...
SELECT
    athlete_id, lt1_value, lt1_measured_at, lt1_iana_timezone, lt1_source, lt1_notes, lt2_value, lt2_measured_at, lt2_iana_timezone, lt2_source, lt2_notes, vo2max_value, vo2max_measured_at, vo2max_iana_timezone, vo2max_source, vo2max_notes, weight_value, weight_measured_at, weight_iana_timezone, weight_source, weight_notes, max_hr_value, max_hr_measured_at, max_hr_iana_timezone, max_hr_source, max_hr_notes, resting_hr_value, resting_hr_measured_at, resting_hr_iana_timezone, resting_hr_source, resting_hr_notes
FROM
...
type GetAthleteVolumeRow struct {
	...
	TotalMovingTimeSeconds     int64
	TotalElevationGainMeters   int32
	LongestElapsedTimeSeconds  int64
	LongestDistanceMeters      int32
	LongestMovingTimeSeconds   int64
	LongestElevationGainMeters int32
	HrZoneTotals               string
}
...
func (q *Queries) GetAthleteVolume(ctx context.Context, arg GetAthleteVolumeParams) ([]GetAthleteVolumeRow, error) {
	...
	for rows.Next() {
		...
		if err := rows.Scan(
			...
			&i.TotalMovingTimeSeconds,
			&i.TotalElevationGainMeters,
			&i.LongestElapsedTimeSeconds,
			&i.LongestDistanceMeters,
			&i.LongestMovingTimeSeconds,
			&i.LongestElevationGainMeters,
			&i.HrZoneTotals,
		); err != nil {
			return nil, err
		}
...
SELECT
	id, provider_id, athlete_id, provider_raw_activity_id, name, description, sport, start_time, end_time, iana_timezone, utc_offset, elapsed_time, moving_time, distance, elev_gain, elev_loss, avg_speed, avg_hr, max_hr, summary_polyline, summary_route, gpx_file_uri, fit_file_uri, created_at, updated_at, deleted_at, hr_zone_distribution
...
DO UPDATE SET
	...
	gpx_file_uri = $22,
	fit_file_uri = $23,
	hr_zone_distribution = $24
RETURNING id, provider_id, athlete_id, provider_raw_activity_id, name, description, sport, start_time, end_time, iana_timezone, utc_offset, elapsed_time, moving_time, distance, elev_gain, elev_loss, avg_speed, avg_hr, max_hr, summary_polyline, summary_route, gpx_file_uri, fit_file_uri, created_at, updated_at, deleted_at, hr_zone_distribution
`
...
type UpsertActivityEnduranceParams struct {
	...
	HrZoneDistribution    pqtype.NullRawMessage
}
