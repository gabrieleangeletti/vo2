...
const (
	...
	Vo2AthleteMeasurementTypeMaxHr     Vo2AthleteMeasurementType = "max_hr"
	Vo2AthleteMeasurementTypeRestingHr Vo2AthleteMeasurementType = "resting_hr"
)
...
type Vo2AthleteCurrentMeasurement struct {
	...
	MaxHrValue            sql.NullFloat64
	MaxHrMeasuredAt       sql.NullTime
	MaxHrIanaTimezone     sql.NullString
	MaxHrSource           NullVo2AthleteMeasurementSource
	MaxHrNotes            sql.NullString
	RestingHrValue        sql.NullFloat64
	RestingHrMeasuredAt   sql.NullTime
	RestingHrIanaTimezone sql.NullString
	RestingHrSource       NullVo2AthleteMeasurementSource
	RestingHrNotes        sql.NullString
}
