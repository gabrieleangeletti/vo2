...
func newAthleteCurrentMeasurements(m models.Vo2AthleteCurrentMeasurement) *vo2.AthleteCurrentMeasurements {
	return &vo2.AthleteCurrentMeasurements{
		...
		MaxHrValue:          m.MaxHrValue.Float64,
		MaxHrMeasuredAt:     m.MaxHrMeasuredAt.Time,
		MaxHrTimezone:       m.MaxHrIanaTimezone.String,
		MaxHrSource:         vo2.AthleteMeasurementSource(m.MaxHrSource.Vo2AthleteMeasurementSource),
		MaxHrNotes:          m.MaxHrNotes.String,
		RestingHrValue:      m.RestingHrValue.Float64,
		RestingHrMeasuredAt: m.RestingHrMeasuredAt.Time,
		RestingHrTimezone:   m.RestingHrIanaTimezone.String,
		RestingHrSource:     vo2.AthleteMeasurementSource(m.RestingHrSource.Vo2AthleteMeasurementSource),
		RestingHrNotes:      m.RestingHrNotes.String,
	}
}
