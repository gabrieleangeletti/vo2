...
type AthleteCurrentMeasurements struct {
	...
	MaxHrValue          float64                  `json:"maxHrValue,omitzero" db:"max_hr_value"`
	MaxHrMeasuredAt     time.Time                `json:"maxHrMeasuredAt,omitzero" db:"max_hr_measured_at"`
	MaxHrTimezone       string                   `json:"maxHrTimezone,omitzero" db:"max_hr_timezone"`
	MaxHrSource         AthleteMeasurementSource `json:"maxHrSource,omitzero" db:"max_hr_source"`
	MaxHrNotes          string                   `json:"maxHrNotes,omitzero" db:"max_hr_notes"`
	RestingHrValue      float64                  `json:"restingHrValue,omitzero" db:"resting_hr_value"`
	RestingHrMeasuredAt time.Time                `json:"restingHrMeasuredAt,omitzero" db:"resting_hr_measured_at"`
	RestingHrTimezone   string                   `json:"restingHrTimezone,omitzero" db:"resting_hr_timezone"`
	RestingHrSource     AthleteMeasurementSource `json:"restingHrSource,omitzero" db:"resting_hr_source"`
	RestingHrNotes      string                   `json:"restingHrNotes,omitzero" db:"resting_hr_notes"`
}
