...
GRANT USAGE ON SCHEMA vo2 TO vo2;

GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA vo2 TO vo2;

GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA vo2 TO vo2;